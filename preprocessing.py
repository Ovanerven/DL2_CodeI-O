...
def parse_args():
    ...
    parser.add_argument("--embedding_path", type=str, default="all_embeddings.npy", help="Path to save/load embeddings")
    parser.add_argument("--reduced_embedding_path", type=str, default="reduced_embeddings.npy", help="Path to save/load reduced embeddings")
    parser.add_argument("--labels_path", type=str, default="hdbscan_labels_reduced10_mcs20_ms5.npy", help="Path to HDBSCAN clustering labels")
    parser.add_argument("--probabilities_path", type=str, default="hdbscan_probabilities_reduced10_mcs20_ms5.npy", help="Path to HDBSCAN probabilities")
    ...
    parser.add_argument("--min_cluster_size", type=int, default=20, help="Min cluster size for HDBSCAN")
